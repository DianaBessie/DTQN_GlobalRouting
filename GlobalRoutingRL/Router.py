...
def DRL_implementation(filename,globali):
    ...
    #        print('Routing net No.',sortedHalfWireLength[i][0])
        ...
        agent = DTQN_Implementation.Agent(environment_name, sess, graphcase)   
    ...
    # if testing using training function, comment burn_in
        ...
        agent.replay = DTQN_Implementation.Replay_Memory() #Remove memeory of previous training
